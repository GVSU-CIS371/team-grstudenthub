...
<template>
  <div class="restaurant-page">
    ...
    <h1>📍 Campus Events</h1>
    <p>Check out what's happening at GVSU!</p>

    <div v-if="eventStore.loading" class="loader">Loading Laker life...</div>
    ...
    <div v-else class="results-grid">
      ...
      >
        ...
        <div class="biz-bg-box">
          <v-icon color="white" size="48">mdi-calendar-star</v-icon>
        </div>
